defmodule SimplePasswordAuthWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SimplePasswordAuthWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SimplePasswordAuthWeb.Gettext, "errors", msg, opts)
    end
  end
